...
export default function SignUp({ scrollToHome, scrollToLogIn }) {
  ...
  const FACULTIES = [
    "วิศวกรรมศาสตร์(TSE)", "นิติศาสตร์(LAW)", "พาณิชยศาสตร์และการบัญชี(TBS)",
    ...
    "วิทยาลัยนานาชาติ ปรีดี พนมยงค์(PBIC)", "วิทยาลัยพัฒนาศาสตร์ ป๋วย อึ๊งภากรณ์(PSDS)"
  ];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://jerseyjamtu.onrender.com/add-user/register', {
        method: 'POST',
